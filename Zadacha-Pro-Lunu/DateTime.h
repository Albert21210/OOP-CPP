...
public:
	...
	// дополнительные методы для задачи с Луной
	std::string getYYYY() const;
	std::string getYYYYMMDD() const;
	void printMoonResult(const std::string& rise, const std::string& culmination, const std::string& set) const;
};