...
plt.plot(n_predict, t_predict, 'rs', markersize=9, label=f'Прогноз (N=2M): {t_predict:.1f}s')
...
plt.title('Анализ сложности алгоритма Иосифа (Array)', fontsize=14)
